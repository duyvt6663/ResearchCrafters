...
the surface is split by role per `backlog/03-cli-runner.md`.
...
- `backlog/03-cli-runner.md` — full command surface, OAuth device-code flow,
  submission bundling, error UX, distribution.

## Related Backlog Items

- `backlog/04-validation-evaluator.md` — `validate` subcommand layer 1-4 checks.
- `backlog/08-infra-foundations.md` — auth foundations and signed URL helpers.
