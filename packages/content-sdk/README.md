...
- `TODOS/02-erp-content-package.md` — package anatomy, ARA layers, fixture
  acquisition, review gates.

## Related TODOs

- `TODOS/04-validation-evaluator.md` — validator consumes content-sdk loaders.
- `TODOS/06-data-access-analytics.md` — package build mirroring into `stages`,
