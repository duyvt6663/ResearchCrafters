...
| `erp-schema/` | ERP file schemas (package, graph, stage, branch, rubric, runner) | `04-validation-evaluator.md` |
| `content-sdk/` | package loading, ARA cross-link, package build | `02-erp-content-package.md` |
| `evaluator-sdk/` | rubric grader, LLM grading guardrails, redaction | `04-validation-evaluator.md` |
| `ai/` | mentor context builder, LLM gateway, leak tests | `05-mentor-safety.md` |
