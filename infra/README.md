...
- `backlog/08-infra-foundations.md` — environments, DB, queue, storage, runner
  base images, secrets, observability, CI/CD, privacy foundations, SLO targets.

## Related Backlog Items

- `backlog/03-cli-runner.md` — runner image content and security posture.
- `backlog/06-data-access-analytics.md` — DB provisioning and retention policies.
